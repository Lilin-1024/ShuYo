              ...
              child: ListView(
                ...
                children: [
                  ...
                  _section(
                      ...
                      tail: '只需举报即可。如果累积了足够多的举报，就会自动采取措施，或在版主的干预下采取措施。',
                      emphasizeTail: true),
                  _section(context, '始终保持文明', ['没有什么比粗鲁更能破坏健康的对话了：'],
                      bullets: const [
                  ...
                  _section(context, '保持整洁',
                      ...
                      bullets: const [
                        ...
                        '不要发布无内容的回复。',
                        '不要中途改变话题。',
                        '不要在您的帖子上签名 — 每个帖子都附有您的个人资料。'
                      ],
                      tail:
                          '不要发布“+1”或“同意”，而要使用“点赞”按钮。不要从完全不同的方向讨论现有话题，而要使用“作为链接话题回复”。'),
                  _section(context, '仅发布自己的内容', [
                    '未经允许，您不得发布属于他人的任何数字内容。您不得发布关于窃取他人知识产权（软件、视频、音频、图像）或违反任何其他法律的描述、链接或方法。'
                  ]),
                  _section(context, '由您助力', [
                    '本网站由您友好的版主团队和您（社区）共同运营。如果您对事情的运作方式有任何其他疑问，请开设新话题，我们一起讨论！如果您有无法通过元话题或举报解决的严重或紧急问题，请联系版主。'
                  ]),
                ],
              ),
            ),
  ...
  static Widget _section(
    ...
    for (final p in paragraphs) {
      children.add(Padding(
          ...
          child: Text(p,
              style: TextStyle(
                  color: colors.textPrimary, fontSize: 16, height: 1.55))));
    }
    ...
    if (tail != null) {
      children.add(Text(tail,
          style: TextStyle(
              color: colors.textPrimary,
              fontSize: 16,
              height: 1.55,
              fontWeight: emphasizeTail ? FontWeight.w700 : FontWeight.w400)));
    }
    return Padding(
